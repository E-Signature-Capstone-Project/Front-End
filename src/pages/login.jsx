  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 relative shadow-2xl">
        ...
        <h2 className="text-2xl font-bold text-center mb-4 text-gray-900">Successfully</h2>
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (baselineStatus.hasBaseline) {
        console.log('✅ User has complete baseline → redirecting to Dashboard');
        ...
        console.log(`⚠️ User has ${baselineStatus.count}/5 baseline → redirecting to Baseline Sign`);
        
        let message = '';
        if (baselineStatus.count > 0) {
          message = `You have ${baselineStatus.count}/5 baseline signatures. Please complete your baseline setup.`;
        } else {
          message = 'Please set up your baseline signatures to continue using the system.';
        }
        ...
        setSuccess('Login successful! Please complete your baseline signatures.');
      }
      ...
      if (error.message.includes('401') || error.message.includes('invalid') || error.message.includes('incorrect')) {
