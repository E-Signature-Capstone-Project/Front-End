...
import Sidebar from "../components/sidebar"; // ⬅️ Tambahan
import {
  FaFileAlt,
  FaExternalLinkAlt,
  FaFolderOpen,
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <FaFilePdf className="text-[#003E9C] text-xl" />
            ...
            <button
              className="w-full flex items-center justify-center gap-2 bg-[#003E9C] text-white font-medium py-2 rounded-lg mb-3 hover:bg-[#002A6B] transition"
              onClick={() => {
                if (selectedFile) {
            ...
            <button
              className="w-full flex items-center justify-center gap-2 border border-[#003E9C] text-[#003E9C] font-medium py-2 rounded-lg hover:bg-blue-50 transition"
              onClick={() => {
                alert("Request TTD");
                setShowPopup(false);
              }}
