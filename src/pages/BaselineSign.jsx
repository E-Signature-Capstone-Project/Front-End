...
export default function BaselineSign() {
  ...
  const handleSave = () => {
    ...
    if (currentStep >= maxSignatures) {
      // Jika sudah 5 signature, simpan dan redirect
      const userEmail = localStorage.getItem('userEmail');
            ...
            {!showDrawBox ? (
              ...
              <div className="bg-white rounded-2xl shadow-md p-6 mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={saveDrawing}
                    className="flex-1 bg-red-600 text-white font-medium py-2 rounded-lg hover:bg-red-700 transition-colors text-sm"
                  >
                    Apply
                  </button>
                </div>
            ...
            {!currentSignature ? (
              <div className="space-y-2">
                <button
                  ...
                  disabled={currentStep > maxSignatures || showDrawBox}
                  className="w-full bg-red-600 text-white py-2.5 rounded-lg font-medium shadow hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm"
                >
                  <FaPencilAlt />
                  Draw Signature
                </button>
                ...
                <label className="block">
                  <input
                    ...
                    className="hidden"
                  />
                  <div className="w-full bg-red-600 text-white py-2.5 rounded-lg font-medium shadow hover:bg-red-700 transition-colors cursor-pointer flex items-center justify-center gap-2 text-sm">
                    <FaUpload />
                    Upload From Gallery
                  </div>
                </label>
              ...
              <div className="flex gap-2">
                <button
                  onClick={handleSave}
                  className="flex-1 bg-red-600 text-white py-2.5 rounded-lg font-medium shadow hover:bg-red-700 transition-colors text-sm"
                >
                  Save Signature
                </button>
